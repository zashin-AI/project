...
from tensorflow.keras.applications import MobileNet, VGG16, DenseNet121, ResNet101
...
# 평가, 예측
model = load_model('C:/nmb/nmb_data/h5/5s/densenet/resnet_rmsprop_1.h5')
# model.load_weights('C:/nmb/nmb_data/h5/5s/densenet/resnet_rmsprop_1.h5')
