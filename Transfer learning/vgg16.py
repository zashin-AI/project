...
model.save('C:\\nmb\\nmb_data\\h5\\pre_train\\vgg16_sgd.h5')
...
path = 'C:\\nmb\\nmb_data\\h5\\pre_train\\vgg16_sgd_1e3.h5'
mc = ModelCheckpoint(path, monitor='val_loss', verbose=1, save_best_only=True)
tb = TensorBoard(log_dir='C:/nmb/nmb_data/graph/'+ 'vgg16_sgd_1e3' + "/",histogram_freq=0, write_graph=True, write_images=True)
